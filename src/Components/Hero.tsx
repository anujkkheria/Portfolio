...
const Hero:React.FC = () => {
  return (
    <div className='grid grid-cols-3 grid-rows-3 bg-blue-600 h-[92vh] p-2'>
        ...
        <div className=' text-white absolute bottom-6 right-2.5 bg-blue-600 '>I am <div className='inline-block h-6 pr-2 bg-white overflow-y-hidden pl-1'><ul className='dynamic bg-white text-blue-600 inline-block font-bold overflow-y-hidden leading-6 pl-1'>
        <li>Anuj</li>
        <li>a Developer</li>
